...
namespace CozmicMinner
{
    ...
    public partial class AddModifyServerForm : RadForm
    {
        ...
        /// </summary>
        /// <param name="serverID"></param>
        public AddModifyServerForm(Guid serverID)
        {
            this.InitializeComponent();
        ...
        {
            if (Mode == FormMode.Update) return false;

            var data = RepositoryFactory.ServerRepository.Find(x => x.ServerName.Equals(this.txtServerName.Text));
        ...
        MiningServer CreateServer()
        {
            ...
            this.miningServer.ServerDescription = this.txtServerName.Text;
